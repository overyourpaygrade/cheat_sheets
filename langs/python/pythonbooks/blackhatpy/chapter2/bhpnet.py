...
def usage():
  ...
  print "-e --execute=file_to_run   - execute the file upon recieving a connection"
...
def client_handler(client_socket):
  ...
  if len(upload_destination):
    ...
    # Keep reading data until nothing available
    while True:
      ...
      # No we take the bytes and try to write them out
      try:
        file_descriptor = open(upload_destination,"wb")
        file_descriptor.srite(file_buffer)
  ...
  # Into another loop if a command shell was requested
  if command:
